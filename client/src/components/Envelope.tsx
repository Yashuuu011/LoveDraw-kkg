    ...
    <div className="w-full max-w-xl mx-auto flex flex-col items-center py-6">
      ...
      <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] max-w-lg cursor-pointer group" onClick={handleOpen}>
        ...
        <motion.div
          ...
          className="absolute left-4 right-4 bottom-4 top-4 glass-panel bg-blush-50 text-plum-950 rounded-2xl p-6 sm:p-8 shadow-2xl flex flex-col justify-between border border-gold-300/40"
        >
          {/* Top Letter Header */}
          ...
          <div className="my-auto py-4 text-center">
            <motion.p
              ...
              className="font-serif text-xl sm:text-2xl lg:text-3xl text-burgundy-900 leading-relaxed font-semibold"
            >
              "{message.message}"
            </motion.p>
          </div>
