    ...
    <div className="space-y-24 pb-20">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center space-y-8 relative z-10">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/80 dark:glass-panel border border-slate-200 dark:border-rose-400/30 text-rose-500 dark:text-rose-300 text-xs sm:text-sm font-semibold shadow-xl"
          >
            <Sparkles className="w-4 h-4 text-gold-500 dark:text-gold-400 animate-pulse" />
          ...
          >
            ...
            <Link
              to="/daily-love"
              className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/80 dark:glass-card border border-slate-200 dark:border-rose-400/20 hover:border-rose-300 dark:hover:border-rose-400/40 text-slate-700 dark:text-blush-100 font-semibold text-base flex items-center justify-center gap-2.5 transition-all transform hover:-translate-y-1 shadow-sm"
            >
      ...
      {featuredDraw && (
        <section className="max-w-6xl mx-auto px-4">
          <div className="bg-white/80 dark:glass-panel rounded-3xl p-6 sm:p-10 border border-slate-200 dark:border-rose-400/30 shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-white/50 dark:glass-card border border-slate-200 dark:border-rose-400/20 space-y-3">
                  <p className="text-xs text-rose-500 dark:text-rose-300 font-semibold uppercase tracking-wider text-center">
                    Draw Countdown
                  </p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
                  ...
                  <span className="text-xs text-gold-500 dark:text-gold-300 font-semibold">
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-slate-200 dark:border-rose-400/30 shadow-2xl group">
                <img
                  src={featuredDraw.prizeImage}
                  alt={featuredDraw.prizeTitle}
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 dark:from-plum-950/90 via-transparent to-transparent" />

                <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-white/20 dark:glass-card backdrop-blur-md">
                  <p className="text-xs text-gold-400 dark:text-gold-300 font-semibold">Grand Prize</p>
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/80 dark:glass-card rounded-3xl p-8 space-y-4 border border-slate-200 dark:border-rose-400/20 relative group hover:border-rose-300 dark:hover:border-rose-400/40">
            <span className="font-serif text-5xl font-black text-rose-100 dark:text-rose-500/20 group-hover:text-rose-200 dark:group-hover:text-rose-500/40 transition-colors">
              01
            </span>
            <div className="w-12 h-12 rounded-2xl bg-rose-50 dark:bg-rose-500/20 flex items-center justify-center text-rose-500 dark:text-rose-400">
          ...
          <div className="bg-white/80 dark:glass-card rounded-3xl p-8 space-y-4 border border-slate-200 dark:border-rose-400/20 relative group hover:border-rose-300 dark:hover:border-rose-400/40">
            <span className="font-serif text-5xl font-black text-gold-100 dark:text-gold-500/20 group-hover:text-gold-200 dark:group-hover:text-gold-500/40 transition-colors">
              02
            </span>
            <div className="w-12 h-12 rounded-2xl bg-gold-50 dark:bg-gold-500/20 flex items-center justify-center text-gold-500 dark:text-gold-400">
          ...
          <div className="bg-white/80 dark:glass-card rounded-3xl p-8 space-y-4 border border-slate-200 dark:border-rose-400/20 relative group hover:border-rose-300 dark:hover:border-rose-400/40">
            <span className="font-serif text-5xl font-black text-emerald-100 dark:text-emerald-500/20 group-hover:text-emerald-200 dark:group-hover:text-emerald-500/40 transition-colors">
              03
            </span>
            <div className="w-12 h-12 rounded-2xl bg-emerald-50 dark:bg-emerald-500/20 flex items-center justify-center text-emerald-500 dark:text-emerald-400">
      ...
      {recentMemories.length > 0 && (
        <section className="max-w-6xl mx-auto px-4 space-y-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <span className="text-xs font-bold uppercase tracking-widest text-gold-500 dark:text-gold-400">Captured Moments</span>
              <h2 className="font-serif text-3xl font-bold text-rose-600 dark:rose-gradient-text">Recent Memories 📷</h2>
            </div>
            <Link
              to="/memories"
              className="text-sm font-semibold text-rose-500 hover:text-rose-600 dark:text-rose-300 dark:hover:text-white flex items-center gap-1.5 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {recentMemories.map((m) => (
              <div key={m.id} className="bg-white/80 dark:glass-card rounded-2xl overflow-hidden border border-slate-200 dark:border-rose-400/20 group shadow-md">
                <div className="relative aspect-square overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 dark:from-plum-950 via-transparent to-transparent opacity-80" />
                  <div className="absolute bottom-3 left-3 right-3">
                    <p className="text-xs font-bold text-white truncate">{m.title}</p>
                    <p className="text-[10px] text-gold-400 dark:text-gold-300">{m.winnerName || 'Love Community'}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="max-w-4xl mx-auto px-4">
        <div className="bg-white/80 dark:glass-panel rounded-3xl p-10 text-center border border-rose-200 dark:border-gold-400/30 relative overflow-hidden shadow-xl">
          <Heart className="w-12 h-12 text-rose-500/10 dark:text-rose-400/20 fill-rose-500/10 dark:fill-rose-400/20 absolute top-4 left-6" />
          <Heart className="w-16 h-16 text-rose-500/5 dark:text-rose-400/10 fill-rose-500/5 dark:fill-rose-400/10 absolute bottom-4 right-6" />

          <p className="font-serif text-2xl sm:text-3xl text-slate-800 dark:text-blush-50 italic leading-relaxed">
            "Whatever our souls are made of, yours and mine are carved from the very same light."
          </p>
          <p className="text-xs text-rose-500 dark:text-gold-300 font-semibold tracking-widest uppercase mt-4">
            — Romantic Proverb
          </p>
        </div>
      </section>
